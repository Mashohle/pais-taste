...
export function ShoppingCart({ isOpen, onClose }: ShoppingCartProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-96 bg-gradient-to-b from-stone-50/95 via-stone-25/90 to-stone-50/95 backdrop-blur-xl border-l border-stone-200/60 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
