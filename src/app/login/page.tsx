  ...
  return (
    <>
      ...
      <div className="md:hidden min-h-screen bg-stone-50">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-stone-500">
                {showForgotPassword
                  ...
                  : (isLogin
                    ? "Sign in to track orders and favorites"
        ...
        {/* Mobile Content */}
        <div className="bg-stone-50 rounded-t-[2.5rem] -mt-24 relative z-10 min-h-screen" style={{ boxShadow: 'inset 0 8px 12px -8px rgba(0,0,0,0.15)' }}>
          <div className="px-5 pt-8 pb-24">
            ...
            {success && (
              <div className="mb-4 text-green-600 text-sm text-center bg-green-50 border border-green-200 rounded-xl p-3">
                {success}
              </div>
            )}
              ...
              <>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 h-12 bg-white border-stone-200 focus:border-stone-400 focus:ring-2 focus:ring-stone-400/20 rounded-xl"
                          value={formData.name}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 pr-10 h-12 bg-white border-stone-200 focus:border-stone-400 focus:ring-2 focus:ring-stone-400/20 rounded-xl"
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-12 text-base font-semibold bg-stone-700 hover:bg-stone-800 text-white rounded-xl shadow-lg"
                  >
                    {isLoading ? (
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-stone-50 text-stone-500">or</span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    disabled={isLoading}
                    className="w-full h-12 bg-white border-stone-300 hover:border-stone-400 text-stone-700 rounded-xl"
                  >
                ...
                <div className="text-center pt-6">
                  <p className="text-sm text-stone-600">
                    ...
                    <button
                      ...
                      className="ml-1 text-stone-800 hover:text-stone-900 font-medium"
                      disabled={isLoading}
                    >
      ...
      {/* Desktop View - Keep original centered card design */}
      <div className="hidden md:block min-h-screen bg-gradient-to-br from-stone-50 via-stone-100 to-stone-200 flex items-center justify-center p-4 relative overflow-hidden">
